...
public class Commission extends Employee {
	 ...
	 */
	public Commission(int ID, String first, String last, String title, float newSalary, float newThreshold,
			float newRate) {
	...
	public void print() {
		System.out.printf("Commission\t%-10s\t%-15s\t\t%d\t$%.2f\t%.2f\t%.0f\t%.0f\t$%.2f.\n", this.getTitle(),
				this.getFirstName() + " " + this.getLastName(), this.getID(), salary, commissionRate, commissionSales,
				threshold, this.getTotalPay());
	}
