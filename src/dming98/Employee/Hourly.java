...
public class Hourly extends Employee {
	...
	public void print() {
		...
		System.out.printf("Hourly\t\t%-10s\t%-15s\t\t%4d\t$%.2f\t%.2f\t%s\t$%.2f\n", this.getTitle(),
				this.getFirstName() + " " + this.getLastName(), this.getID(), hourlyRate, hoursWorked, overTime,
				this.getTotalPay());
	}
	...
	public int compareTo(Employee otherEmployee) {
		int compare = -1;
		if (otherEmployee instanceof Hourly && this instanceof Hourly) {
